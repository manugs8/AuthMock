...
struct RoutesTests {
    ...
    func health() async throws {
        try await withApp(configure: { app in try routes(app, config: Config(environment: [:]), statusOverride: StatusOverrideBox()) }) { app in
    ...
    func tokenSuccessRoundTrips() async throws {
        ...
        try await withApp(configure: { app in try routes(app, config: config, statusOverride: StatusOverrideBox()) }) { app in
